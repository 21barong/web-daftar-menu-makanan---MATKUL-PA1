...
<div class="content">
    ...
    <h3 class="page-title"> Users </h3>
        ...
        <a href="users_add.php" class="btn"><i class="fa fa-plus"></i></a>
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?= $row['username'] ?></td>
                        <td align="center">
                        <a href="users_edit.php?id= <?= $row['iduser'] ?>" class="btn"><i class="fa fa-edit"></i></a>
                        <a href="?delete=<?= $row['iduser'] ?>" class="btn" onclick="return confirm('Yakin ?')"><i class="fa fa-times"></i></a>
                        </td>
                    </tr>
                        <?php }} else { ?>
