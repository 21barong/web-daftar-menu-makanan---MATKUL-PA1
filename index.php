...
<html>
    <head>
        ...
        <link rel="shortcut icon" href="uploads/icon/favicon.png" type="">
        ...
        <style type="text/css">
            ...
            * {
            ...
            a {
                color: inherit; /* inherit = mengikuti warna parent (navbar) */
...
<body>
  ...
  <!-- navbar -->
	<div class="navbar">
        ...
        <a href="login.php" id="btnBars" style="margin-left: 10px;">
	...
	<div class="banner">
		<div class="banner-text">
			...
			<a href="index.php"><h1>DAMENAN</h1></a>
